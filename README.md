...
- Time after time you have to say that you are in control and that Claude should never run any tests or version control. 
- Jackson marshalling drops the miliseconds in string repesentations of timestamps. This is standard, but you when you are comparing string literals, this might be comfusing. 
